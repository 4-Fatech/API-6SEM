...
| 5 | Média |Como gerente, quero poder estabelecer o número máximo de pessoas na redzone, para garantindo assim que os limites de capacidade sejam respeitados. | 15 | 2 | RF6 |
...
| 7 | Média | Como gerente, desejo uma ferramenta que permita filtrar (por período desejado) os dados de acesso para comparação, para analisar tendências e identificar variações significativas. | 15 | 2 | RF3 |
| 8 | Média | Como gerente, desejo um Dashboard por período feito a partir dos dados de acesso em redzones, para uma análise rápida e eficaz. | 15 | 2 |RF3 |
| 9 | Média | Como gerente geral, quero poder criar uma nova redzone no sistema ela tem que estar atrelada ao departamento que sou responsável, fornecendo informações como nome, responsável e capacidade máxima, para cadastrar as novas redzones. | 10 | 2 |RF6 |
| 10 | Média | Como gerente geral, quero uma página inicial que me permita acessar facilmente todas as redzones monitoradas incluindo métricas importantes como capacidade atual e alertas ativos, para facilitar o gerenciamento.| 10 | 2 |RF6 |
| 11 | Média | Como gerente de área, quero poder cadastrar um novo guarda no sistema, fornecendo seu nome, e-mail e matrícula da empresa, para garantir que a equipe de segurança esteja completa e atualizada. | 10 | 2 | RF5 | 
| 12 | Média | Como gerente geral, quero poder alterar os dados de uma determinada redzone no sistema, para poder cadastrar e corrigir dados já existentes. | 5 | 2 | RF6 |
| 13 | Média | Como gerente de área, quero poder atribuir e alterar o guarda responsável em cada redzone, para que veja apenas a redzone que ele é responsável. | 5 | 2 | RF6 |
| 14 | Média | Como gerente de área, quero poder visualizar os guardas(gerente) responsáveis em cada redzone, para garantir a distribuição de responsabilidades. | 5 | 2 | RF5 |
| 15 | Média | Como gerente de área, quero ter todas as funcionalidades e permissões disponíveis para o gerente, para ter controle sobre o sistema e suas operações. | 5 | 2 | RF9 | 
| 16 | Média | Como gerente geral, quero poder desativar uma determinada redzone, para garantir a segurança e integridade das áreas monitoradas. | 1 | 2 | RF6 | 
| 17 | Baixa | Como gerente, quero um sistema de login que impeça o acesso as URLs sem autenticação, para proteger minha conta e garantir que apenas usuários autorizados tenham acesso ao sistema. | 5 | 2 | RF9 | 
| 18 | Baixa |Como gerente, quero poder recuperar minha senha através de um processo seguro e confiável, para caso eu a esqueça no futuro. | 5 | 2 | RF9 | 
| 19 | Média |Como gerente, quero poder gerar relatórios personalizados para a redzone, com média de ocupação, horários de pico e se excedeu o limite, para ter uma compreensão detalhada do comportamento e atividade nessa área específica. | 30 | 3 | RF4 | 
| 20 | Média | Como gerente área, quero um dashboard que compile e exiba métricas importantes de todos as redzones que são do meu departamento, incluindo capacidade atual, número de alertas ativos e média de permanência das pessoas, para facilitar a análise e tomada de decisões estratégicas. | 20 | 2 | RF2 |
